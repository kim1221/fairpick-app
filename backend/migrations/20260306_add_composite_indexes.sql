...
CREATE INDEX IF NOT EXISTS idx_canonical_events_unenriched
...
CREATE INDEX IF NOT EXISTS idx_canonical_events_no_embedding
  ON canonical_events (created_at DESC)
